...
public class HazelcastKnowledgeAccessor implements IHazelcastKnowledgeAccessor {
	...
	/* (non-Javadoc)
	 * @see fr.irit.smac.amasfactory.util.impl.IHazelcastKnowledgeAccessor#registerKnowledge(fr.irit.smac.amasfactory.agent.IKnowledge)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.irit.smac.amasfactory.util.impl.IHazelcastKnowledgeAccessor#removeKnowledge(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.irit.smac.amasfactory.util.impl.IHazelcastKnowledgeAccessor#getKnowledge(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.irit.smac.amasfactory.util.impl.IHazelcastKnowledgeAccessor#getKnowledgeIdSet()
	 */
	@Override
